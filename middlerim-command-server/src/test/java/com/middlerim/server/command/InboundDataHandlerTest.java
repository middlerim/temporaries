...
public class InboundDataHandlerTest {
  ...
  public void testMessageAndExit() {
    ...
    data = new byte[]{Headers.TEXT, sessionIdBytes1[0], sessionIdBytes1[1], sessionIdBytes1[2], sessionIdBytes1[3], sessionIdBytes1[4], sessionIdBytes1[5], sessionIdBytes1[6], sessionIdBytes1[7],
    ...
    assertEquals(Unpooled.unmodifiableBuffer(Unpooled.wrappedBuffer(
        new byte[]{Headers.TEXT, sessionIdBytes2[6], sessionIdBytes2[7], sessionIdBytes1[0], sessionIdBytes1[1], sessionIdBytes1[2], sessionIdBytes1[3],
